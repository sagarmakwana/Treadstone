...
dataQuestion = pd.read_csv('bytecup2016data/processedQuestionWordInfo.csv', sep=",", header=None)
dataUser = pd.read_csv('bytecup2016data/processedUserWordInfo.csv', sep=",", header=None)
print "Data loaded"
