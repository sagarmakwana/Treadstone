...
print "PCA End"
with open('bytecup2016data/pcaQuestionCharacterInfo.csv', 'wb') as pcaCharacterInfoFile:
...
with open('bytecup2016data/pcaUserCharacterInfo.csv', 'wb') as pcaCharacterInfoFile:
